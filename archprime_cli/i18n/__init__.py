"""archprime-cli i18n — bundled translations + lookup loader.
...
Usage in subcommands:
    ...
    from archprime_cli.i18n import t, current_lang
...
"""
from archprime_cli.i18n.loader import current_lang, set_current_lang, t
