...
<head>
<meta charset="utf-8">
<title>archprime-cli login</title>
<style>
...
<html lang="en">
<head><meta charset="utf-8"><title>archprime-cli login error</title></head>
<body style="font-family:sans-serif;padding:2rem;background:#FAF9F7">
<h1 style="color:#dc2626">archprime-cli login failed</h1>
<p>{error}</p>
...
class _Handler(BaseHTTPRequestHandler):
    ...
    server_version = "archprime-cli/0.1"
...
class AuthServer:
    ...
    def start(self) -> None:
        ...
        self._thread = threading.Thread(
            ...
            daemon=True,
            name="archprime-cli-auth-server",
        )
        self._thread.start()
